...
//  */
// const IP_ADDRESS = '172.16.19.32'; // ← CHANGE THIS to your machine's IPv4 address
// const PORT = 3002;
...
/*
  ...
  Since backend is deployed on Render,
  we use the live API instead of localhost.
*/

const API_BASE_URL = "https://expirio-back.onrender.com/api";
...
export const itemAPI = {
  createItem: (userId, itemData) =>
    api.post("/items", { userId, ...itemData }),
